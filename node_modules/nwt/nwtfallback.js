	...
	find: {
		ID: function( match, context, isXML ) {
			if ( typeof context.getElementById !== "undefined" && !isXML ) {
				...
				// nodes that are no longer in the y #6963
...
(function(){
	...
	var div = y.createElement("div");
	div.appendChild( y.createComment("") );
...
if ( y.querySelectorAll ) {
	(function(){
		...
		Sizzle = function( query, context, extra, seed ) {
			...
			// Only use querySelectorAll on non-XML ys
			// (ID selectors don't work in non-HTML ys)
...
(function(){
	...
	if ( matches ) {
		...
		var disconnectedMatch = !matches.call( y.createElement( "div" ), "div" ),
			pseudoWorks = false;
				...
				try {
					if ( pseudoWorks || !Expr.match.PSEUDO.test( expr ) && !/!=/.test( expr ) ) {
						...
						if ( ret || !disconnectedMatch ||
								// As well, disconnected nodes are said to be in a y
								// fragment in IE 9, so check for that
								node.y && node.y.nodeType !== 11 ) {
							return ret;
						}
					}
				} catch(e) {}
...
nwt.augment('Event', 'pageX', function () {
	if (this._e.clientX) {
		return this._e.pageX = this._e.clientX + y.body.scrollLeft + y.documentElement.scrollLeft
	}
});

nwt.augment('Event', 'pageY', function () {
	if (this._e.clientY) {
		return this._e.pageY = this._e.clientY + y.body.scrollTop + y.documentElement.scrollTop
	}
});
// Checks if we support transitions
function supportsTransitions () {
    var b = y.body || y.documentElement;
    var s = b.style;
    var p = 'transition';
